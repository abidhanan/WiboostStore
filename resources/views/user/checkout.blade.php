    ...
    <div class="max-w-md w-full relative z-10">
        <div class="bg-gradient-to-br from-[#8faaf3] to-[#5a76c8] rounded-[2rem] p-8 text-center text-white shadow-xl shadow-[#5a76c8]/30 mb-6 border-4 border-white relative overflow-hidden">
            ...
            <div class="relative z-10">
                <h2 class="font-black text-3xl tracking-tight drop-shadow-sm">Selesaikan Pembayaran</h2>
                <p class="text-[#e0fbfc] text-sm mt-2 font-bold">Satu langkah lagi untuk memproses pesananmu.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[2rem] shadow-lg shadow-[#bde0fe]/30 border-4 border-white overflow-hidden p-6 md:p-8">
            ...
            <div class="flex items-center justify-between mb-5 pb-5 border-b-2 border-dashed border-[#f0f5ff]">
                ...
                <span class="font-black text-[#5a76c8] bg-[#f0f5ff] px-3 py-1 rounded-xl text-sm border border-white shadow-inner">{{ $transaction->invoice_number }}</span>
            </div>

            <div class="flex items-center justify-between mb-5 pb-5 border-b-2 border-dashed border-[#f0f5ff]">
                <span class="text-[#8faaf3] text-xs font-black uppercase tracking-widest">Produk / Layanan</span>
                <span class="font-black text-[#2b3a67] text-right max-w-[60%]">{{ $transaction->product->name }}</span>
            </div>

            <div class="flex items-center justify-between mb-8">
                <span class="text-[#8faaf3] text-xs font-black uppercase tracking-widest">Total Tagihan</span>
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('user.history') }}" class="text-sm font-black text-[#8faaf3] hover:text-[#ff6b6b] hover:bg-[#ffe5e5] px-6 py-2 rounded-full transition-colors border-2 border-transparent hover:border-white inline-block">Batal & Kembali</a>
            </div>
        </div>
        
        <p class="text-center text-xs font-black text-[#8faaf3] mt-6 uppercase tracking-widest flex items-center justify-center gap-1">
