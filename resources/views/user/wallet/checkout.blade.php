    ...
    <div class="max-w-md w-full relative z-10">
        <div class="bg-gradient-to-br from-[#8faaf3] to-[#5a76c8] rounded-[2.5rem] p-8 text-center text-white shadow-xl shadow-[#5a76c8]/30 mb-6 border-4 border-white relative overflow-hidden transform hover:scale-[1.02] transition-transform duration-300">
            ...
            <div class="relative z-10">
                ...
                <h2 class="font-black text-3xl tracking-tight drop-shadow-sm">Pembayaran <span class="text-[#e0fbfc]">Top Up</span></h2>
                <p class="text-white/90 text-sm mt-2 font-bold drop-shadow-sm">Selesaikan pembayaran untuk mengisi saldo Wiboost kamu.</p>
            </div>
        </div>
        ...
        <div class="bg-white/95 backdrop-blur-sm rounded-[2.5rem] shadow-2xl shadow-[#bde0fe]/40 border-4 border-white overflow-hidden p-6 md:p-8">
            ...
            <div class="flex items-center justify-between mb-5 pb-5 border-b-4 border-dashed border-[#f4f9ff]">
                ...
                <span class="font-black text-[#5a76c8] bg-[#f4f9ff] px-4 py-1.5 rounded-full text-sm border-2 border-white shadow-sm">{{ $deposit->invoice_number }}</span>
            </div>

            <div class="flex items-center justify-between mb-5 pb-5 border-b-4 border-dashed border-[#f4f9ff]">
                <span class="text-[#8faaf3] text-[10px] font-black uppercase tracking-widest">Layanan</span>
                <span class="font-black text-[#2b3a67] text-right bg-[#f8faff] px-4 py-1.5 rounded-full text-sm border border-white">Top Up Saldo Wiboost</span>
            </div>

            <div class="flex items-center justify-between mb-8 bg-[#f8faff] p-5 rounded-[1.5rem] border-2 border-[#f0f5ff] shadow-inner">
                <span class="text-[#8faaf3] text-[10px] font-black uppercase tracking-widest">Total Deposit</span>
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('user.wallet.index') }}" class="text-sm font-black text-[#8faaf3] hover:text-[#ff6b6b] hover:bg-[#ffe5e5] px-6 py-3 rounded-full transition-colors border-2 border-transparent hover:border-white inline-block shadow-sm">Batal & Kembali</a>
            </div>
        </div>
