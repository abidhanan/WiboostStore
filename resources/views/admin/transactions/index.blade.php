...
@section('admin_header_actions')
    <a href="{{ route('admin.transactions.index') }}" class="flex w-full items-center justify-center gap-2 rounded-full border-4 border-white bg-white px-6 py-3 font-black text-[#5a76c8] shadow-lg shadow-[#bde0fe]/30 transition-all hover:-translate-y-1 hover:bg-[#f0f5ff] sm:w-auto">
